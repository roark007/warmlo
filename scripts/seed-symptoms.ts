...
const symptoms = [
  ...
  },
  {
    ...
    relatedCodes: [
      { brand: "armstrong-air", code: "271" },
      { brand: "daikin", code: "e6" },
      { brand: "tempstar", code: "6-flash" },
      { brand: "heil", code: "6-flash" },
      { brand: "comfortmaker", code: "6-flash" },
  ...
  },
  {
    ...
    snippetAnswer:
      "Four flashes on a furnace LED usually means the high-limit switch opened from overheating — most often a dirty filter. On Goodman and Daikin, the same fault may show as code E3 on a 7-segment display.",
    plainExplanation:
      "Four-flash patterns indicate the furnace overheated and the limit switch tripped. Restricted airflow from a clogged filter is the most common cause. On newer Goodman, Amana, and Daikin boards, the identical fault may read E3 on the display instead of four LED flashes.",
    likelyCauses: [
    ...
    relatedCodes: [
      { brand: "goodman", code: "4-flash" },
      { brand: "amana", code: "4-flash" },
      { brand: "daikin", code: "4-flash" },
      { brand: "tempstar", code: "4-flash" },
