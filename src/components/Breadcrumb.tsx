...
export function BrandCard({ slug, name, codeCount }: BrandCardProps) {
  return (
    <StaticLink
      href={`/fix/${slug}`}
      className="card-lift relative rounded-md border border-line bg-surface p-4 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-pilot-600"
    >
